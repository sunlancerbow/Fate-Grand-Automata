...
class Game @Inject constructor(val prefs: IPreferences) {
    companion object {
        ...
        val finishedLotteryBoxRegion get() = when {
            ...
            Phone.s.contains("SM-G975U") -> Region(488, 850, 140, 100)
            else -> Region(560, 850, 140, 100)
        }
    }
