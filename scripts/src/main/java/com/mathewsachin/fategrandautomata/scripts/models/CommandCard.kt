    ...
    class Face private constructor(
        ...
        companion object {
            val list = listOf(
                Face(
                    index = 1,
                    clickLocation = Location(250, 1000),
                ...
                Face(
                    index = 2,
                    clickLocation = Location(770, 1000),
                ...
                Face(
                    index = 3,
                    clickLocation = Location(1280, 1000),
                ...
                Face(
                    index = 4,
                    clickLocation = Location(1790, 1000),
                ...
                Face(
                    index = 5,
                    clickLocation = Location(2310, 1000),
