...
sealed class CommandCard(
    ...
    class Face private constructor(
        ...
        companion object {
            val list = listOf(
                Face(
                    index = 1,
                    clickLocation = Location(150, 1000),
                ...
                Face(
                    index = 2,
                    clickLocation = Location(670, 1000),
                ...
                Face(
                    index = 3,
                    clickLocation = Location(1180, 1000),
                ...
                Face(
                    index = 4,
                    clickLocation = Location(1690, 1000),
                ...
                Face(
                    index = 5,
                    clickLocation = Location(2210, 1000),
    ...
    class NP private constructor(
        ...
        companion object {
            val list = listOf(
                NP(
                    clickLocation = Location(720, 500),
                    autoSkillCode = '4',
